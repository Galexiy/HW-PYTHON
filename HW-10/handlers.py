...
#         await message.answer('Ошибка! Введите команду /duel пробел номер id противника')
#         return
    
#     opponent_id = message.text.split()[1]
#     if not opponent_id.isdigit():
#         await message.answer('Ошибка! неверный id противника, введите правильно.')
#         return
    
#     if opponent_id == str(message.from_user.id):
#         await message.answer('Ошибка! Ты не можешь играть сам с собой!')
#         return
    

#     duel.append(int(message.from_user.id)) 
       
#     duel.append(int(opponent_id))
...
#     global new_game
#     if len(message.text.split()) != 2:
#         await message.answer('Ошибка! Введите команду /set пробел количество конфет')
#         return
#     name = message.from_user.first_name
